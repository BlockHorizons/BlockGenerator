...
use BlockHorizons\BlockGenerator\biomes\impl\UnknownBiome;
...
abstract class CustomBiome extends Biome
{
	...
	public const
		...
		HELL = 8,
		END = 9,
		FROZEN_OCEAN = 10, //DOES NOT GENERATE NATURALLY
		FROZEN_RIVER = 11,
		ICE_PLAINS = 12,
		MUSHROOM_ISLAND = 14,//
		...
		FOREST_HILLS = 18,
		TAIGA_HILLS = 19,
		EXTREME_HILLS_EDGE = 20, //DOES NOT GENERATE NATURALLY
		JUNGLE = 21,
		JUNGLE_HILLS = 22,
		JUNGLE_EDGE = 23,
		DEEP_OCEAN = 24,
	...
	public static function getBiome(int $id): CustomBiome
	{
		if ($id < 0 || $id > self::MAX_BIOMES) {
			return new UnknownBiome();
		}

		if (!isset(self::$customBiomes[$id])) {
