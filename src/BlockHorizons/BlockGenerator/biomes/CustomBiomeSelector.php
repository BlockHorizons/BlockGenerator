...
class CustomBiomeSelector extends BiomeSelector
{
	...
	private Simplex $ocean;
	private Simplex $river;
	private Simplex $hills;
	private Simplex $rain;
	...
	public function pickBiome($x, $z): CustomBiome
	{
...
//                    $biome = CustomBiome::FROZEN_OCEAN;
		...
		return CustomBiome::getBiome($biome);
	}
